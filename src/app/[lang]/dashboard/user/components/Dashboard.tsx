...
import {
  FiHome, FiBook, FiMessageSquare, FiCalendar,
  ...
  return (
    <div className="flex h-screen bg-[#F5F7FA] text-[#333333]">
      ...
      <motion.aside
        ...
        className="w-64 bg-[#1A2F50] text-white flex flex-col py-6 px-4 space-y-8 shadow-lg"
      >
        <h1 className="text-2xl font-bold text-center">E-learning</h1>

        <nav className="flex flex-col space-y-4 text-base font-medium">
          <button
            onClick={() => router.push('/dashboard')}
            className="flex items-center space-x-3 hover:bg-[#4A76A8] hover:rounded-lg px-4 py-2 transition"
          >
      ...
      <div className="flex-1 flex flex-col p-6 overflow-y-auto">
        ...
        >
          <div>
            <h2 className="text-2xl font-bold text-[#1A2F50]">
